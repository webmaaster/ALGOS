...
# input: [5, -23, -3, 7, 21]
# calculate the number of positive values in the array /list --->3
# Set the last value in the original array to be that number
# input: [5, -23, -3, 7, 3]
...
# print(count_positives([5, -23, -3, 7, 21]))
